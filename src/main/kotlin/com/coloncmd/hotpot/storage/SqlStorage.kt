...
class SqlStorage(
    ...
    override suspend fun findRequest(id: String): WebhookRequest? =
        db {
            RequestsTable
                .selectAll()
    ...
    override suspend fun findResponseFor(requestId: String): WebhookResponse? =
        db {
            ResponsesTable
                .selectAll()
    ...
    private fun ResultRow.toWebhookRequest() =
        WebhookRequest(
    ...
    private fun ResultRow.toWebhookResponse() =
        WebhookResponse(
